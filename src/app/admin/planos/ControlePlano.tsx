        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="ml-auto flex gap-2">
            ...
            <button
              ...
              onClick={desligar}
              disabled={indo}
              className="rounded-lg border border-mata-200 px-3 py-1.5 text-sm font-medium text-red-700 disabled:opacity-50"
            >
              Encerrar
            </button>
          </div>
      ...
      {abrindo && (
        <div className="mt-3 rounded-xl bg-sol-50 p-4">
          ...
          <div className="mt-3 flex flex-wrap items-end gap-3">
            <label className="block">
              ...
              <input
                ...
                className="mt-1 block rounded-lg border border-mata-200 bg-white px-3 py-2 text-sm"
              />
            </label>
            <div className="flex gap-1.5">
              {[1, 3, 6, 12].map((meses) => (
                <button
                  ...
                  className="rounded-lg border border-mata-200 bg-white px-2.5 py-2 text-xs font-medium hover:bg-mata-50"
                >
          ...
          <input
            ...
            className="mt-3 w-full rounded-lg border border-mata-200 bg-white px-3 py-2 text-sm"
          />
